...
## Project Overview
This projects builds an end-to-end engineering pipeline using NYC 311 service request data.
The pipeline extracts data from a public API, loads the raw data into PostgreSQL, transforms it into
analytics-ready tables, runs data quality checks, and documents the workflow for reproducibility.
...
This project demonstrates core data engineering responsibilities: extracting, loading, transforming, validating, 
orchestrating, and documenting data workflows. 
